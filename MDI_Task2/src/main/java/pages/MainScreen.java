...
public class MainScreen {
    ...
    // Define locators using AppiumBy
    ...
    private final By unitSettingId = AppiumBy.xpath("//android.widget.TextView[@text=\"Unit setting\"]");
    ...
    public void getMainScreen() throws InterruptedException {
